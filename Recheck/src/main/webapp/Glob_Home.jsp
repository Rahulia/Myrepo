    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on("click", ".addSectionBtn", function() {
                ...
                // Price and number of seats input (combined)
...
<body>
    <div class="container">
        ...
        <form action="Create_Seatmap" method="post">
            <input type="hidden" name="hallId" value="<%-- Replace with actual hallId retrieval logic --%>">
